...
function isEmpty(sToCheck) {
   ...
   return false;
        ...
        function searchmain(str)
        {
            ...
            var strs = _.filter(str.split(querySplitter), Boolean);
...
DR_EXPLAIN.searchManager = (function(){
    var _class = {
        ...
        performSearch: function( s ) {
            var queryArray = _.filter(this.searchEngine.trim(s).split(this.searchEngine.querySplitter()), Boolean);
            var output = '';
        ...
        searchComplete: function() {
            ...
            if ( searchResultsArr.length > 0 ) {
                ...
                var searchQueryArr = _.filter(this.searchEngine.trim(searchQuery).split(this.searchEngine.querySplitter()), Boolean);
