...
/*js/drexplain/nav-tree/views/navTree.item.view.js*/
	window.NavTree__Item_View = Backbone.View.extend({
		...
		render: function( childsOutput ) {
			var tpl = '<div class="b-tree__itemContent"><span class="b-tree__itemText"><a href="<%- link %>" class="b-tree__itemLink"><%- title %></a></span></div>';
			var tplSelected = '<div class="b-tree__itemContent m-tree__itemContent__selected"><span class="b-tree__itemText m-tree__itemText__selected"><%- title %></span></div>';
	...
	window.NavTree__ItemKeyword_View = Backbone.View.extend({
		...
		render: function( childsOutput ) {
			...
			if ( this.model.hasOneLink() ) {
				...
				tpl = '<div class="b-tree__itemContent"><span class="b-tree__itemText"><a href="<%- link %>" class="b-tree__itemLink"><%- title %></a></span></div>';
			}
			else {
				tpl = '<div class="b-tree__itemContent"><span class="b-tree__itemText"><span class="b-tree__itemLink"><%- title %></span></span></div>';
			}
...
/*js/drexplain/nav-tree/views/navTree.contextMenu.view.js*/
	window.NavTree__ContextMenu_View = Backbone.View.extend({
		...
		show: function() {
			...
			var tpl = '<li class="b-tree__item"><div class="b-tree__itemContent"><span class="b-tree__spacer"><span class="b-tree__i_article"><span class="b-tree__i_article_inner"></span></span></span><span class="b-tree__itemText"><a href="<%- link %>" class="b-tree__itemLink"><%- title %></a></span></div></li>';
			this.template = _.template( tpl );
...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["User Guide","Copyrights and Trademarks","Getting Started","Welcome Dialog","Manage Project Dialog","Prepare Data Dialog","Specify Match Dialog","Perform Match Dialog","Review Match Dialog","Best Practices","How To Install","Record Linkage FAQs","User Interface","Planning a Linkage Project","The Auto Pilot","Projects Tab","Locations Tab","Standards Tab","Comparisons Tab","Simulation Tab","Options Tab","About Tab","Test Standard Methods","Test Compare Methods","Data Sources Tab","Self Matches Tab","Dual Matches Tab","Triple Match Tab","Reports Tab","Options Tab","Link to Tables Tab","Select Input Tab","Review Input Tab","Standardize Tab","Review Std Tab","Test Values Tab","Specify Match Header","Specify Join Fields Tab","Specify Match Fields Tab","Test Pass Specs Tab","Match Passes Tab","Merge Passes Tab","Matched Pairs Tab","Tolerance Tests Tab","Outcome Tests Tab","Bayesian Estimates Tab","How to Select Cases for Linkage","How to Make Prior Estimates","How to Select Join Fields","How to Select Match Fields","How to Correct Dependent Outcomes","How to Check the Linkage Model","Find a Model with Good Fit","How to Use SQL Server","Typical User Dialog","Starting the Auto Pilot","AutoPilot Flight Plans","AutoPilot Notes","Auto Pilot Flight Log","Standard Methods","Compare Methods","Options","New Source Name","New Self Match Name","New Dual Match Name","Frequency Table Input","Frequency Table Standard","New Pass Name","Estimate Total Matches","View Linked Pairs","Bayesian Model Check Details","Data Link Properties"],
	DREX_NODE_LINKS: ["user_guide.html","copyrights_and_trademarks.html","getting_started.html","welcome_dialog.html","manage_project_dialog.html","prepare_data_dialog.html","specify_match_dialog.html","perform_match_dialog.html","review_match_dialog.html","best_practices.html","how_to_install.html","record_linkage_faqs.html","user_interface.html","planning_a_linkage_project.html","the_auto_pilot.html","projects.html","locations.html","standards.html","comparisons.html","simulation.html","options1.html","about.html","test_standard_methods.html","test_compare_methods.html","data_sources.html","self_matches.html","dual_matches.html","triple_match.html","reports.html","options2.html","link_to_tables.html","select_input.html","review_input.html","standardize.html","review_standard.html","test_values.html","specify_match_header.html","specify_join_fields.html","specify_match_fields.html","test_pass_specs.html","match_passes.html","merge_passes.html","matched_pairs.html","tolerance_tests.html","outcome_tests.html","bayesian_estimates.html","how_to_select_cases_for_linkage.html","how_to_make_prior_estimates.html","how_to_select_join_fields.html","how_to_select_match_fields.html","how_to_correct_dependent_outcomes.html","how_to_check_the_linkage_model.html","find_a_model_with_good_fit.html","how_to_use_sql_server.html","typical_user_dialog.html","starting_the_auto_pilot.html","autopilot_flight_plans.html","autopilot_notes.html","auto_pilot_flight_log.html","standard_methods.html","compare_methods.html","options.html","new_source_name.html","new_self_match_name.html","new_dual_match_name.html","frequency_table_input.html","frequency_table_standard.html","new_pass_name.html","estimate_total_matches.html","view_linked_pairs.html","bayesian_model_check_details.html","data_link_properties.html"],
	DREX_NODE_CHILD_START: [1,10,10,15,24,30,36,40,42,46,54,54,54,55,55,59,59,59,60,61,61,62,62,62,62,63,64,65,65,65,65,65,65,66,66,67,67,68,68,68,69,69,69,70,70,70,70,70,70,70,70,70,71,71,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72],
	DREX_NODE_CHILD_END: [10,10,15,24,30,36,40,42,46,54,54,54,55,55,59,59,59,60,61,61,62,62,62,62,63,64,65,65,65,65,65,65,66,66,67,67,68,68,68,69,69,69,70,70,70,70,70,70,70,70,70,71,71,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72],
	DREX_MENU_TYPE: 1,
